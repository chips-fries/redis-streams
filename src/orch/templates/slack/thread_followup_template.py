...
class SlackThreadFollowupTemplate:
    def __init__(
        ...
        **kwargs,
        ...
        self.main_text = main_text or "(Follow-up Reminder)"
        self.thread_template = thread_template or "{{main_text}}"
    ...
    def build_payload(self) -> Dict[str, Any]:
        ...
        text = self.thread_template.replace("{{main_text}}", self.main_text)
