# src/orch/flows/scheduled/launch_due_reminder_checks_flow.py
...
from orch.flows.thread_followup_flow import thread_followup_flow
...
if __name__ == "__main__":
    launch_due_reminder_checks_flow()
